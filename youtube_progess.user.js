...
#buttonsbefore{display:inherit;padding:1px 0px 8px 7px}\
.updaterstyle:active{\
...
var style = document.createElement('style');
    ...
    if($('#revert').prop('checked')==false){
        $('#showhidenum').text($('ytd-grid-video-renderer[hided*="true"]').size());
    } else {
